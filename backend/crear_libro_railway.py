...
def elegir_layout(fotos_grupo, layout_anterior="", variante=0):
    ...
    if n == 2:
        if layout_anterior == "2H":
            ...
            return "2V", fotos_grupo
    if n == 3:
        # 4 variantes (grande a la izquierda/derecha/arriba/abajo) en vez
        # de una sola fija, para que no se repita siempre la misma
        # composición - se evita repetir la del hueco justo anterior.
        opciones = [o for o in ("3I", "3D", "3T", "3B") if o != layout_anterior]
