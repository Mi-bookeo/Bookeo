...
from crear_libro_railway import generar_propuestas_portada, leer_fecha, preparar_fotos_ordenadas, extraer_fotograma
            ...
            for ruta_video in videos_rutas:
                ...
                try:
                    ...
                    if ruta_frame:
                        ...
                        thumb_urls[nombre_archivo] = generar_url_descarga(clave_r2_thumb, expira_segundos=3600 * 24)
                except Exception as e:
...
async def crear_pedido_subir_video(
    ...
    try:
        ...
        return {"ok": True, "qr_url": url, "thumb_url": thumb_url}
